	...
	<!-- Content -->
		<div class="col-md-8" id="content">
					...
					<ul>
						<li><a href="#">MẮT</a></li>
							...
							<ul class="sub-menu">
								...
								<li><a href="#">CHE KHUYẾT ĐIỂM</a></li>
								<li><a href="#">CHÂN MÀY</a></li>
								<li><a href="#">LÔNG MI GIẢ</a></li>
							</ul>
			...
			<section class="section">
				<div class="makeup_top">
					<img src="image/palette-cho-mat.jpg" class="image">
					<div class="makeup_intro">
						<p>
							<strong>Đôi mắt là cửa sổ tâm hồn...</strong>
						</p>
						<p>
							…và&nbsp;chúng tôi chính là người mở cánh cửa đó bằng những sản phẩm trang điểm ưu việt nhất. Với sự đa dạng về màu sắc, chủng loại và kiểu dáng, mỹ phẩm e.l.f. cam kết đem đến cho bạn một đôi mắt ấn tượng, sắc sảo với mức giá sẽ khiến bạn yêu ngay.&nbsp;
						</p>						
					</div>
					<div class="clear"></div>
				</div>
				...
				<div>
					<table id="banchay-table">
						...
						<tr>
							<td>
								<img src="image/pm.png" href="#">
								<p></p>
								<p>Combo</p>
								<p>2.333.330 VNđ</p>
							</td>
							<td>
								<img src="image/pm_1.png" href="#">
								<p></p>
								<p>Palette Mắt 10 Màu Không Bóng Nhũ</p>
								<p>480.000 VNđ</p>
							</td>
							<td>
								<img src="image/pm_2.jpg" href="#">
								<p></p>
								<p>Palette Phấn Mắt 10 Màu Chuyên Nghiệp</p>
								<p>430.000 VNđ</p>
							</td>
						</tr>
						<tr>
							<td>
								<p></p>
								<img src="image/pm_3.jpg" href="#">
								<p></p>
								<p>Phấn Mắt 6 Màu Chuyên Nghiệp</p>
								<p>400.000 VNđ</p>
							</td>
							<td>
								<p></p>
								<img src="image/pm_4.jpg" href="#">
								<p></p>
								<p>Phấn Mắt 3 Màu Chuyên Nghiệp</p>
								<p>210.000 VNđ</p>
							</td>
						</tr>
						<tr>
