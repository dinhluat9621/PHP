...
<body>
	...
	<!-- Content -->
      ...
      <!-- Logo content -->
			...
			<div>
				<img src="image/banner-lien-he.jpg" alt="">
			</div>			
			<div><p></p></div>
			<div class="sub-menu">
			  	<ul>
			...
			<aside>
				<ul class="parent">
					...
					<li><a href="#">FQA</a></li>
					<li><a href="#">CHẾ ĐỘ GIAO HÀNG</a></li>
			...
			<section>
				<div>
					<p class="titl">LIÊN HỆ VỚI CHÚNG TÔI</p>
					<form action="" method="post" accept-charset="uft-8">
					<table>
					<tr>
					    <td><p></p></td>
					</tr>
					<tr>
						<td>
							<p></p><br>
							<label id="label"><b>Họ tên (*)</b><p></p></label>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<p></p><br>
							<label id="label"><b>Email (*)</b><p></p></label>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<p></p><br>
							<label id="label"><b>Số điện thoại (*)</b><p></p></label>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<p></p><br>
							<label id="label"><b>Nội dung (*)</b></label>
						</td>
					</tr>
					<tr>
						<td>
							<textarea name="noidung" cols="50" rows="10" ></textarea> <br><br>
							<input type="Submit" name="gui" class="butt">
							<p></p>
						</td>
					</tr>
					</table>
